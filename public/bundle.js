...
var _SearchPlugin = __webpack_require__(75);

var _SearchPlugin2 = _interopRequireDefault(_SearchPlugin);

var _UsersList = __webpack_require__(79);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _SearchPlugin2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/userlist', component: _UsersList2.default })
        )
    )
...
var _AgeField = __webpack_require__(77);

var _AgeField2 = _interopRequireDefault(_AgeField);

var _NameField = __webpack_require__(78);
    ...
    _createClass(UserForm, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_NameField2.default, { value: '', ref: 'nameField' }),
                _react2.default.createElement(_AgeField2.default, { value: '5', ref: 'ageField' }),
...
var AgeField = function (_Component) {
    _inherits(AgeField, _Component);
    ...
    _createClass(AgeField, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { type: "number", value: this.state.value, onChange: this.onChange, style: { borderColor: color } })
            );
        }
    }]);
    ...
    _createClass(NameField, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { type: "text", value: this.state.value, onChange: this.onChange, style: { borderColor: color } })
            );
        }
    }]);
...
var UserList = function (_Component) {
    ...
    function UserList(props) {
        ...
        _this.state = {
            users: [{ id: 0, name: 'Jon' }, { id: 1, name: 'Sanny' }, { id: 2, name: 'Rose' }] };
        return _this;
    }
    ...
    _createClass(UserList, [{
        key: 'render',
        value: function render() {
            var listItems = this.state.users.map(function (user, index) {
                return _react2.default.createElement(
                    'li',
                    { key: index },
                    user.name
